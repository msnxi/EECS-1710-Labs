...
void setup() {
  ...
  //space background
  space = loadImage("spacebg.jpg"); //https://wallpaperaccess.com/pixel-space
  space.resize(space.width * (height / space.height), height); 
  
  //rocket setup
  rocket = loadImage("spaceship.png"); //https://www.pngegg.com/en/png-ytppr
  ...
  //asteroid setup
  asteroid = loadImage("asteroid.png"); //https://www.pngfind.com/mpng/xTimJh_asteroid-pixel-art-red-button-hd-png-download/
